package dev.webfx.extras.webtext.peers.elemental2.html;
...
import dev.webfx.kit.mapper.peers.javafxgraphics.elemental2.html.layoutmeasurable.HtmlMeasurableNoVGrow;
 ...
 * @author Bruno Salmon
 */
public final class Elemental2HtmlTextPeer
    ...
    public Elemental2HtmlTextPeer() {
        this((NB) new HtmlTextPeerBase());
    }

    Elemental2HtmlTextPeer(NB base) {
