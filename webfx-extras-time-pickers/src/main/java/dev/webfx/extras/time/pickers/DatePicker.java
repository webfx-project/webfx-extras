...
public final class DatePicker {
    ...
    public Node getView() {
        if (container == null) {
            ...
            SVGPath arrowPreviousMonthPath = new SVGPath();
            ...
            arrowPreviousMonthPane = new MonoPane(arrowPreviousMonthPath);
            arrowPreviousMonthPane.setOnMouseClicked(event -> setDisplayedYearMonth(month.minusMonths(1)));

            SVGPath arrowNextMonthPath = new SVGPath();
            ...
            arrowNextMonthPane = new MonoPane(arrowNextMonthPath);
            arrowNextMonthPane.setOnMouseClicked(event -> setDisplayedYearMonth(month.plusMonths(1)));
            ...
            yearMonthSelectionHBox.setLeft(arrowPreviousMonthPane);
            yearMonthSelectionHBox.setCenter(displayedYearMonthLabel);
            yearMonthSelectionHBox.setRight(arrowNextMonthPane);
            ...
            daysOfMonthPane.setPadding(new Insets(5));
            ...
            if (options.isApplyBorderStyle())
                container.getStyleClass().addAll("border", "background");
            else {
    ...
    private void onMonthChanged(YearMonth newMonth) {
        ...
        if (arrowPreviousMonthPane != null)
            arrowPreviousMonthPane.setOnMouseClicked(event -> setDisplayedYearMonth(newMonth.minusMonths(1)));
        if (arrowNextMonthPane != null)
            arrowNextMonthPane.setOnMouseClicked(event -> setDisplayedYearMonth(newMonth.plusMonths(1)));
    ...
    private void bindDisplayedYearMonthLabel() {
        displayedYearMonthLabel.textProperty().bind(LocalizedTime.formatYearMonthProperty(getDisplayedYearMonth(), TextStyle.FULL_STANDALONE));
    }
