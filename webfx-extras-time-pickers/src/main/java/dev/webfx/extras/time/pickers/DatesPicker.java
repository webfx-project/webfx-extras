...
public class DatesPicker {
    ...
    private final ObjectProperty<String> selectedDateCssProperty = new SimpleObjectProperty<>("webfx-time-pickers-selected");
    ...
    private void generateCalendarPane(YearMonth month) {
        ...
        arrowPreviousMonthPath.getStyleClass().add("webfx-time-pickers-arrow");
        ...
        arrowNextMonthPath.getStyleClass().add("webfx-time-pickers-arrow");
        ...
        monthYearLabel.getStyleClass().add("webfx-time-pickers-month");
